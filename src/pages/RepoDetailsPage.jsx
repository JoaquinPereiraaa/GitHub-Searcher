...
const RepoDetailsPage = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center relative">
      ...
      <p className='text-3xl '>Nombre del repositorio: {repoData.name}</p>
      <p className='text-3xl'>Propietario: {repoData.owner.login}</p>
      <p className='text-3xl'>Descripción: {repoData.description}</p>
      <p className='text-3xl no-underline hover:underline' > <a href={repoData.html_url} target="_blank">Ver en GitHub</a></p>
